...
# time RACE_TYPE=ve FORECAST_YEAR=2026 ./process-one-race.sh
...
time RACE_TYPE=${RACE_TYPE} FORECAST_YEAR=${FORECAST_YEAR} BATCH_RUN_TS=${RUN_TS} PROCESSING_BATCH_ID=ngboost-norm-tuned-reviewed NGB_EXTRA_ITERATIONS=0 NGB_METRICS_JSON=data/ngb-metrics.json ENABLE_DEBUG_PLOTS=true uv run jupyter nbconvert --to notebook --inplace  --ExecutePreprocessor.timeout=36000  --execute ngboost-norm-tuned-reviewed.ipynb
