    ...
    for row in rows:
        ...
        if team_id is not None:
            ...
            if name is not None and name != " " and leg is not None:
                ...
                output_rows.append([current_team_id, current_team_name, current_team_base_name, leg, leg_dist(leg), name])
    return output_rows


out_file_name = 'data/running_order-2_j2017_ju.tsv'
...
url = "https://registration.jukola.com/?kieli=en&kisa=j2017&view=1&sarja=ju&jarj=kilpnro&jj=1"
