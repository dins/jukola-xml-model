...
def _read_running_order_runs(race_type: str) -> list[runner_linking.Run]:
    ...
    running_order["name"] = running_order["name"].str.lower().str.strip().str.replace(r" +", " ", regex=True)
...
def _write_individual_runs_file(grouped_runs_by_unique_name: dict[str, list[dict[str, Any]]]) -> None:
